...
# ElderGuard Activity-Level Prediction 
...
The dataset contains reading from environmental sensors as well as other informatiomn
...
# Models Used
Logistic Regression	- Baseline model for simple comparison
Decision Tree Classifier - Interpretable rule-based model
Random Forest Classifier - Ensemble model for better performance and feature importance
